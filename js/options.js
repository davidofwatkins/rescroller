...
$(document).ready(function () {
  ...
  $("body").on("click", ".miniColors-apply a", function () {
    //applies listener to the <a> that hasn't been created yet
    var colorSelectorInput = $("#" + lastClickedColorPickerPropertyID).children(
  ...
  showButtons.change(function () {
    ...
    if ($(this).is(":checked")) {
      ...
      $("#buttons-toggleable").slideDown("fast", function () {
        refreshScrollbars();
      });
    } else {
      Rescroller.properties.set($(this).attr("id"), "unchecked");
      $("#buttons-toggleable").slideUp("fast", function () {
        refreshScrollbars();
      });
    }
  });
  ...
  $(".toggle-hover-active").change(function () {
    if ($(this).is(":checked")) {
      //alert("Checked!");
      Rescroller.properties.set($(this).attr("id"), "checked");
      $("#" + $(this).attr("data-wrapperid")).slideDown("slow", function () {
        refreshScrollbars();
      });
    } else {
      //alert("Unchecked!");
      Rescroller.properties.set($(this).attr("id"), "unchecked");
      $("#" + $(this).attr("data-wrapperid")).slideUp("slow", function () {
        refreshScrollbars();
      });
    }
